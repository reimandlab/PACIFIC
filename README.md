...
## Example run 1:
Here, we use SurvFS to search for prognostic mutation features in the example dataset, without including any other control variable in the model. Run `SurvFS_step1()` for 20 iterations:
```R
library(SurvFS)
