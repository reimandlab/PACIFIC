...
Download `extdata/inst/TCGA_LUSC_example_dataset.rds` and import it in your script:
```R
...
```
<img src="extdata/inst/km1.jpg" width="50%">
...
```
<img src="extdata/inst/km2.jpg" width="100%">
